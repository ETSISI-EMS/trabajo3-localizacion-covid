...
public class ContactosCovid {
	...
	public void loadData(String data, boolean reset) throws EmsInvalidTypeException, EmsInvalidNumberOfDataException,
		...
		leerFicheroDatos(datas);
	}

	public void loadDataFile(String fichero, boolean reset) {
		File archivo = null;
		String datas[] = null, data = null;
		loadDataFile(fichero, reset, archivo, datas, data);
	...
	public void leerFicheroDatos(String datas[]) throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicateLocationException, EmsDuplicatePersonException {
