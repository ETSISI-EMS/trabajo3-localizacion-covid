...
public class ContactosCovid {
	...
	public ContactosCovid() {
		setPoblacion(getPoblacion());
		setLocalizacion(getLocalizacion());
		setListaContactos(getListaContactos());
	}
	...
	for (int i = 1; i < Constantes.MAX_DATOS_PERSONA && i < setters.size() + 1; i++) {
		String s = data[i];
		setters.get(i - 1).accept(s);
	}
